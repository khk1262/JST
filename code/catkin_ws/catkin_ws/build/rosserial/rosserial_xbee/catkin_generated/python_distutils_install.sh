...
echo_and_run cd "/home/cart/catkin_ws/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/cart/catkin_ws/src/rosserial/rosserial_xbee/setup.py" \
     \
    build --build-base "/home/cart/catkin_ws/build/rosserial/rosserial_xbee" \
    install \
    --root="${DESTDIR-/}" \
