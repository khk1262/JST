...
echo_and_run cd "/home/cart/catkin_ws/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/cart/catkin_ws/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/cart/catkin_ws/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
