...
echo_and_run cd "/home/cart/catkin_ws/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/cart/catkin_ws/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/cart/catkin_ws/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
